# [Source: Open-Sora-Plan] opensora/models/causalvideovae/model/losses/discriminator.py
# [Modified - oliviaa] Removed relative import of CausalConv3d (unused by NLayerDiscriminator3D)
import functools
